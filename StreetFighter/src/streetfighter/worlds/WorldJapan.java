...
public class WorldJapan extends World {
	...
	public WorldJapan(Handler handler, int fighter1, int fighter2, int mode) {
	...
	public void render(Graphics g) {
		//Dibujar el fondo
		g.drawImage(Assets.fondoNocheJapanStage, (int) (stageSpawnX - xOffset), (int)(-28 + yOffset), stageWidth, stageHeight,null);
		//Nubes y luna
		g.drawImage(animacionesStage.get(3).getCurrentFrame(), 
				(int) (stageSpawnX /*- xOffset*0.2*/), (int)(-24 + yOffset), stageWidth, 300, null);
		//g.drawImage(Assets.nube1, 
		//		(int) (200 /*- xOffset*0.2*/), (int)(200 + yOffset), 700, 75, null);
		//Mansion
		g.drawImage(animacionesStage.get(2).getCurrentFrame(), 
					(int) (600 - xOffset*0.5), (int)(132 + yOffset), 500, 250, null);
		//Tejadillo medio
		g.drawImage(animacionesStage.get(1).getCurrentFrame(), 
					(int) (stageSpawnX - xOffset*0.75), (int)(-10 + yOffset), stageWidth, stageHeight+10, null);
		//Suelo
		g.drawImage(animacionesStage.get(0).getCurrentFrame(), 
					(int) (stageSpawnX - xOffset), (int)(-24 + yOffset), stageWidth, stageHeight+24, null);
